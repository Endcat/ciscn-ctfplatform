...
export default new Vuex.Store({
  state: {
    ...
    purpleScheme: {
      ...
      boxShadow: {
        'box-shadow': '0 4px 10px 0 rgb(137, 102, 201)',
        'color': '#383838',
      },
      fontColor: {
        'color': '#383838',
    ...
    blackScheme: {
      ...
      boxShadow: {
        'box-shadow': '0 4px 10px 0 rgb(30, 30, 30)',
        'color': '#d9e3e8',
      },
      fontColor: {
        'color': '#d9e3e8',
    ...
    cyanScheme: {
      ...
      boxShadow: {
        'box-shadow': '0 4px 10px 0 rgb(128, 165, 202)',
        'color': '#383838',
      },
      fontColor: {
        'color': '#383838',
    ...
    pinkScheme: {
      ...
      boxShadow: {
        'box-shadow': '0 4px 10px 0 rgb(202, 158, 177)',
        'color': '#383838',
      },
      fontColor: {
        'color': '#383838',
    ...
    yellowScheme: {
      ...
      boxShadow: {
        'box-shadow': '0 4px 10px 0 rgb(199, 134, 67)',
        'color': '#383838',
      },
      fontColor: {
        'color': '#383838',
